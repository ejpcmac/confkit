...
alias cicl='cargo install --path . --target=x86_64-unknown-linux-musl'
...
alias cer='cargo embed --release'
alias ct='cargo test'
alias cnt='cargo nextest run'
alias cs='cargo size'
alias csr='cargo size --release'
alias ctw='cargo watch -x test'
alias cntw='cargo watch -x "nextest run"'
