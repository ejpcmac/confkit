...
# zfs
alias z='zfs'
alias zl='zfs list -o name,available,used,referenced,usedbysnapshots,compressratio,mountpoint'
alias zlb='zfs list -o name,used,usedbydataset,usedbysnapshots,readonly,com.sun:auto-snapshot,syncoid:sync'
alias zlm='zfs list -o name,encroot,keystatus,canmount,mounted,mountpoint'
alias zlp='zfs list -o name,usedbydataset,compressratio,compression,recordsize,quota,readonly,exec,setuid,canmount,mountpoint'
alias zlsp='zfs list -o name,quota,available,used,usedbydataset,usedbychildren,usedbysnapshots,usedbyrefreservation,compressratio,compression'
alias zls='zfs list -r -d 1 -t snapshot -o name,used,refer,compressratio'
alias zlbm='zfs list -r -d 1 -t bookmark -o name,refer'
alias zc='zfs create'
...
alias wzl='watch -n 1 zfs list -o name,available,used,referenced,usedbysnapshots,compressratio,mountpoint'
alias wzlb='watch -n 1 zfs list -o name,used,usedbydataset,usedbysnapshots,readonly,com.sun:auto-snapshot,syncoid:sync'
alias wzlm='watch -n 1 zfs list -o name,encroot,keystatus,canmount,mounted,mountpoint'
alias wzlp='watch -n 1 zfs list -o name,usedbydataset,compressratio,compression,recordsize,quota,readonly,exec,setuid,canmount,mountpoint'
alias wzlsp='watch -n 1 zfs list -o name,quota,available,used,usedbydataset,usedbychildren,usedbysnapshots,usedbyrefreservation,compressratio,compression'
alias wzls='watch -n 1 zfs list -r -d 1 -t snapshot -o name,used,refer,compressratio'
alias wzlbm='watch -n 1 zfs list -r -d 1 -t bookmark -o name,refer'
...
alias zlc='zl -r $(pwz)'
alias zlbc='zlb -r $(pwz)'
alias zlmc='zlm -r $(pwz)'
alias zlpc='zlp -r $(pwz)'
alias zlspc='zlsp -r $(pwz)'
alias zlsc='zls $(pwz)'
alias zlbmc='zlbm $(pwz)'
