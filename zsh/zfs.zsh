...
alias zpcc='zpool create -O acltype=posixacl -O atime=off -O checksum=sha512 -O compression=lz4 -O dnodesize=auto -O normalization=formD -O reservation=1G -O xattr=sa'
...
alias szpcc='sudo zpool create -O acltype=posixacl -O atime=off -O checksum=sha512 -O compression=lz4 -O dnodesize=auto -O normalization=formD -O reservation=1G -O xattr=sa'
