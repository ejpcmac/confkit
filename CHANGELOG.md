...
* [Zsh/Git] Do not delete `.jj/` in `gclean`.
...
* **BREAKING** [NixOS/Features/Filesystems] Create filesystems for persistence
...
* [home-manager/Programs/GPG] Switch the key server to `hkps://keys.openpgp.org`
    and do not automatically retrieve keys.
* [Zsh/direnv] Remove `rust-toolchain.toml` from the watch list of the `.envrc`
    generated by `nixify`, which was there needlessly.

## [release-24.11] - 2024-12-22

*Initial release for NixOS 24.11*
...
## [release-24.05] - 2024-08-03

*Initial release for NixOS 24.05*
...
* [NixOS] Add support for NixOS 23.05.
...
* [Flake] Provide a flake template.
...
[release-24.05]: https://github.com/ejpcmac/confkit/compare/v0.0.20...release-24.05
